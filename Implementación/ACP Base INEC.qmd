...
```{r}
g <- factoextra::fviz_pca_ind(ACPsup_INEC, labelsize = 8, repel = TRUE, axes = c(1,2)) +  labs(title = "",
         subtitle = "",
         x = TeX("$\\textbf{c^{1}}$ (76.81%)"),
         y = TeX("$\\textbf{c^{2}}$ (12.48%)"))
...
```{r}
g <- factoextra::fviz_pca_var(ACPsup_INEC, labelsize = 8, repel = TRUE, axes = c(1,2))  +  labs(title = "",
         subtitle = "",
         x = TeX("$\\textbf{c^{1}}$ (76.81%)"),
         y = TeX("$\\textbf{c^{2}}$ (12.48%)"))
